...
public class LeadRestController {
  ...
  public ResponseEntity<LeadResponse> createLead(
    ...
    LeadDto created = leadService.addLead(request.getEmail(), request.getCompany(),
  ...
  public ResponseEntity<LeadResponse> updateLead(
    ...
    try {
      LeadDto updated = leadService.updateWithRejectionReason(
          id, request.getEmail(), request.getPhone(), request.getCompany(),
          LeadStatus.valueOf(request.getStatus()), request.getRejectionReasonId());
